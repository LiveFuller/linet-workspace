# CLAUDE.md — Prime Contract (OpenCode + Claude Code + All AIs)

> This file is the single source of truth for AI behavior in this codebase. `AGENTS.md` is kept in sync. The opencode `prime` agent (`/.opencode/agent/prime.md`) extends this contract with execution detail.
...
- `AGENTS.md` (identical content, universal entrypoint)
